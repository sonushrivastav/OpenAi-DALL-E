    ...
    <div className='max-w-7xl mx-auto'>
      <h1 className="font-extrabold text-[#222328] text-[32px]">
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">
          ...
          images through DALL -E AI an share them with the community
        </p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handlesubmit}>
        <div className='flex flex-col gap-5'>
          ...
          <FormField
           ...
           type="text"
           name="prompt"
           placeholder="Enter the Surprise me Text aur Type something to generate Here"
           value={form?.prompt}
            handleChange={handleChange}
            isSurpriseMe
        ...
        <div className='mt-5 flex gap-5'>
          <button
            ...
            type='button' onClick={generateImage}>{generatingImg ? "Generating..." : "Generate"}</button>
        </div>
